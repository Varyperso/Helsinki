...
const Weather = ({ pos }) => {
  ...
  useEffect(() => {
    axios
      .get(`https://api.open-meteo.com/v1/forecast?latitude=${pos[0]}&longitude=${pos[1]}&current=temperature_2m,wind_speed_10m`)
      .then((response) => {
        setWeather(response.data);
      });
  }, [pos]);

  if (!weather) return <div>Waiting for weather api...</div>

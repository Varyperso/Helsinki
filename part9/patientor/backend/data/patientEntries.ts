import { newPatientSchema, Gender } from "../src/patientUtils";
import { PatientEntry } from "../../shared/patientTypes";
...
const patientEntries: PatientEntry[] = data.map(obj => {
  const object = newPatientSchema.parse(obj) as PatientEntry; // NewDiaryEntry => DiaryEntry to add the .id field..
  object.id = obj.id;
  return object;
});
